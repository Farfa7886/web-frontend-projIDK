...
<sep/>
<category name="Other" colour="#8f067a"></category>
<category name="Variables" colour="#a55b80" custom="VARIABLE"/>
<category name="Functions" colour="#995ba5" custom="PROCEDURE"/>
<sep />
<category name="Events" colour="#c7b634">
  <label text="Everything starts here" />
  <block type="project_loaded" />
</category>
<category name="App" colour="#652b87">
  <block type="app_data_get_screen" />
</category>
<category name="Assets" colour="#729e26">
